...
insert into NhanVien values (001,'mk','nv01',113,'Ha noi',132,100000,'1/1/2000','Nam','QuanLy')
...
go
	...
	EXECUTE sp_addrolemember 'ThuKho',@tk
	ELSE
	EXECUTE sp_addrolemember 'ThuThu',@tk
	End
-- thu lại quyền 
go	
...
Select DocGia.MaDocGia,HoTen,SDT,DiaChi,CMT,NgaySinh,GioiTinh From DocGia 
	left join PhieuTra On PhieuTra.MaDocGia=DocGia.MaDocGia
		WHERE  PhieuTra.HanTra < CAST(GETDATE()) 
