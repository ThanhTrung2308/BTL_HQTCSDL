...
Insert into NhanVien
	values ('NV001',N'Nguyễn Thị Yến Nhi',N'Nữ',N'Quảng Ninh','0789254879','ntyn@gmail.com',15660000),
			('NV002',N'Nguyễn Mạnh Hùng',N'Nam',N'Hưng Yên','0145287963','mhung@gmail.com',18500000),
			('NV003',N'Nguyễn Quang Huy',N'Nam',N'Thanh Hóa','0584693155','huy@gmail.com',14700000),
			('NV004',N'Ngô Thị Duyên',N'Nữ',N'Hà Nội','0647521458','duyen@gmail.com',20500000),
...
and PhieuXuat.NgayXuat between '2019-01-01' and '2020-01-01' 
...
alter function sln (@ID_MH char(5), @NgayBD date, @NgayKT date)
returns int 
as 
begin
declare @SLN int
...
alter function F_TongTien(@ID_PN char(5), @Nam date)
returns money
as
begin
